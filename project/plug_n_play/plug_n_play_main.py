...
def display_plug_n_play_tab():
    ...
    st.markdown("""
        <div class='section'>
            <h2>Plug-n-Play Models</h2>
            <p>Welcome to the Plug-n-Play tab! Here you can test the anomaly detection process using our pre-trained models or upload your own models for inference testing.</p>
        </div>
    """, unsafe_allow_html=True)
