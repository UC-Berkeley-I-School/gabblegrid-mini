...
def render_main_content(min_time, max_time):
    ...
    with col9:
        prediction_period = st.selectbox('Prediction Period', 
                                         ...
                                         disabled=disabled,
                                         key='prediction_period_input_beta')
