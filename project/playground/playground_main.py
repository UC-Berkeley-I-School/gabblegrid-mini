...
#             /* Custom styling for the Run Inference button */
#             .stButton button {
#                 font-size: 18px;
#                 font-weight: bold;
#                 color: white;
#                 background-color: #A8D5BA; /* pastel green shade */
#                 padding: 10px 24px;
#                 border: none;
#                 border-radius: 10px;
#                 cursor: pointer;
...
#                 background-color: #85B99C; /* darker pastel green when hovered */
#             }
#         </style>
...
#         # "Run Inference" button within the form to avoid auto re-runs
#         submitted = st.form_submit_button("Run Inference")  # No need for extra button, custom style is applied here

#     # Handle form submission and trigger inference process only if "Run Inference" is clicked
#     if submitted:
    ...
    st.markdown("""
        <style>
            ...
            .stButton button {
                ...
                font-weight: bold;
                color: black;
                background-color: lightgreen; /* Brighter pastel green */
                padding: 10px 24px;
                border: none;
                border-radius: 10px;
                cursor: pointer;
            ...
            .stButton button:hover {
                background-color: green; /* Black on hover */
