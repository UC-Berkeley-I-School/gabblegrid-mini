...
def display_about_us_tab():
    ...
    with col1:
        st.image('/home/ubuntu/efs-w210-capstone-ebs/06.Inference_and_Deployment/00.Git_Code/project/files/images/about_us_photo_1.png', use_column_width=True)
        st.markdown("""
            <div class='section'>
...
As a graduate student at UC Berkeley, I study Natural Language Processing while balancing the demands of a full-time leadership role. I find joy in being both a student and a teacher, an artist, and a technical leader.
    ...
    with col2:
        st.image('/home/ubuntu/efs-w210-capstone-ebs/06.Inference_and_Deployment/00.Git_Code/project/files/images/about_us_photo_2.png', use_column_width=True)
        st.markdown("""
            <div class='section'>
