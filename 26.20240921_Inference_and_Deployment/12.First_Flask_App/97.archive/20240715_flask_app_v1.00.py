...
def predict():
    try:
        ...
        print("X_test shape before slicing:", X_test.shape)  # Debugging line to print the shape of X_test
        ...
        print("X_test shape after slicing:", X_test.shape)  # Debugging line to print the shape after slicing
