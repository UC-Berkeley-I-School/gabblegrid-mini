...
def draw_interaction_diagram():
    ...
    plt.savefig('/home/ubuntu/efs-w210-capstone-ebs/06.Inference_and_Deployment/10.Image_and_Static_Content/interaction_diagram.png')
    plt.close()
...
def main():
    ...
    if st.button('Run Inference'):
        ...
        if results is None:
            ...
            st.image('/home/ubuntu/efs-w210-capstone-ebs/06.Inference_and_Deployment/10.Image_and_Static_Content/interaction_diagram.png')
