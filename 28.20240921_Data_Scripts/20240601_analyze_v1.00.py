...
parser.add_argument("--data_dir", default="/home/sagemaker-user/11.Data/01.BGL/04.Sampled_Parsed_CFDR", help="path to input files", type=str)
...
with open(data_dir + '/bgl_train.csv') as train, open(data_dir + '/bgl_test_normal.csv') as normal, open(data_dir + '/bgl_test_abnormal.csv') as abnormal:
