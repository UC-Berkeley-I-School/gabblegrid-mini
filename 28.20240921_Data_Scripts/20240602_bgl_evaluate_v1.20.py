...
def evaluate_all(data_dir, time_det, normalize, tw=None):
    ...
    base_name = data_dir.split('/')[-1].split('_')[0]
    # with open(f"{data_dir}/{base_name}_train") as train, \
    #      open(f"{data_dir}/{base_name}_test_abnormal") as test_abnormal, \
    #      open(f"{data_dir}/{base_name}_test_normal") as test_normal:
    with open(f"{data_dir}/bgl_train.csv") as train, \
         open(f"{data_dir}/bgl_test_abnormal.csv") as test_abnormal, \
         open(f"{data_dir}/bgl_test_normal.csv") as test_normal:
